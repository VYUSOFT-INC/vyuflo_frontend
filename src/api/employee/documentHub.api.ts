...
// src/api/documentHub.api.ts
//
// UNCHANGED — already has deleteDocument() wired to documentsApi.delete(),
// which already hits your working DELETE /documents/:id endpoint.
// No edits needed here; included for completeness/reference only.
