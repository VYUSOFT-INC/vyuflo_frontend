...
// NAV_BASE has no gap — gap is added per-state so it collapses cleanly
const NAV_BASE =
  'flex items-center rounded-[12px] text-[14px] font-medium tracking-[-0.5px] transition-colors duration-150';

// When collapsed: no horizontal padding, justify-center, explicit height so
// the pill is a square-ish 40×40 touch target centered in the w-16 sidebar.
// When expanded: standard px-3 with gap-3 between icon and label.
const navPad = (collapsed: boolean) =>
  collapsed
  ...
  return (
    <>
      ...
      >
        {/* ── Logo ─────────────────────────────────────────────────────── */}
        {/*
          FIX 2: Logo icon must always be visible when collapsed.
          Previously the outer flex container shrank which clipped the icon too.
          Now: icon is always shrink-0; only the text span collapses to w-0.
          We also tighten gap to 0 on desktop-collapsed so there's no phantom space.
        */}
        ...
        {/* ── Profile ──────────────────────────────────────────────────── */}
        {/*
          FIX 3: Avatar must be centered when collapsed.
          Collapse gap to 0 on desktop-collapsed so the avatar sits in the middle
          of the 64px (w-16) sidebar column without the name text pushing it left.
        */}
...
>>>>>>> Stashed changes
        ...
        {/* ── Nav ──────────────────────────────────────────────────────── */}
        {/* px-4 on mobile/expanded; px-2 when collapsed so icons sit centred in w-16 */}
