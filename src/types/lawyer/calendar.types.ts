...
// Backend convention: Python datetime.weekday() → 0=Mon … 6=Sun
...
/** One row on the attorney_availability table. */
export interface AttorneyAvailabilityRow {
  id?:                    string;
  attorney_id?:           string;
...
/** Bulk save payload for PUT /attorneys/me/availability. */
