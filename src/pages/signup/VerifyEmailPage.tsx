...
//   // Colour of the OTP timer — green → amber → red as it counts down
//   const timerColor =
//     otpTimer > 30 ? "#10b981" :
//     otpTimer > 10 ? "#f59e0b" :
//     "#ef4444";
...
//                         px-6 sm:px-12 lg:px-24 xl:px-32 pt-10 pb-28">
...
//           {/* ── OTP expiry countdown ── */}
//           {!success && (
//             <div className="flex items-center gap-[10px] mb-5 w-full max-w-sm">
//               {/* Progress bar */}
...
//               {/* Timer label */}
//               <span
//                 className="text-[13px] font-bold tabular-nums w-[36px] text-right flex-shrink-0"
