...
function ApprovalStatusCard({ c, onApprove }: { c: HRCaseResponse; onApprove: () => void }) {
  const approvers = [
    ...
    { name: c.attorney?.full_name ?? 'Attorney',  role: 'Immigration Attorney', status: (c.hr_approval_status === 'approved' ? 'approved' : 'pending') as 'approved' | 'pending', date: null },
...
function ActionItemsCard() {
  const [items, setItems] = useState([
    ...
    { id: '3', title: 'Schedule Interview with Attorney', priority: 'medium',   done: false, note: 'Discuss case strategy and timeline with the attorney.' },
              ...
              {activeTab === 'documents' && (
                <HRDocumentManagement
                  ...
                  participants={[
                    ...
                    ...(c.attorney ? [{ name: c.attorney.full_name, role: 'Immigration Attorney' }] : []),
