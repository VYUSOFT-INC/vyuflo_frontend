...
import { callSSOEndpoint } from "../../lib/sso";
import { useAuthStore } from '../../store/authStore';
import { writeUiSessionFromLogin, getUiSession } from '../../utils/uiSession';
import imgLogoIcon     from "../../assets/icons/plane-icon.svg";
import imgShieldIcon   from "../../assets/icons/shield-icon.svg";
import imgBellIcon     from "../../assets/icons/bell-icon.svg";
import imgTeamIcon     from "../../assets/icons/team-icon.svg";
...
export default function Login() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      // ── DEBUG ──
      console.log('[Login] ui_session cookie after write:', getUiSession());
      // ──────────
  ...
  async function handleSSOSuccess(
    ...
    try {
      ...
      // ── DEBUG ──
      console.log('[SSO Login] API response:', {
        tour_employee_seen: data.tour_employee_seen,
        tour_hr_seen:       data.tour_hr_seen,
        theme_color:        data.theme_color,
        roles:              data.roles,
      });
      // ──────────
      ...
      // ── DEBUG ──
      console.log('[SSO Login] ui_session cookie after write:', getUiSession());
      // ──────────
