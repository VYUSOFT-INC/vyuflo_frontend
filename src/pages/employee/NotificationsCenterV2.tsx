...
//           <div className="flex items-center gap-[4px] flex-shrink-0 mt-[2px]">
//             {route && <ArrowRight size={13} className="text-[#d1d5db]" />}
//             <button
//               onClick={e => { e.stopPropagation(); onDismiss(notif.id); }}
//               className="text-[#d1d5db] hover:text-[#6b7280] transition p-[4px]">
//               <MoreVertical size={14} />
...
//             {notif.cta_primary_label && (
//               <button
//                 onClick={e => { e.stopPropagation(); if (!notif.is_read) onMarkRead(notif.id); if (route) navigate(route); }}
//                 className="text-[12px] sm:text-[13px] font-medium px-[14px] py-[6px] rounded-[8px] text-white hover:opacity-90 transition"
//                 style={{ background: "linear-gradient(135deg, var(--theme-primary) 0%, var(--theme-gradient-end) 100%)" }}>
//                 {notif.cta_primary_label}
//               </button>
...
//   // Init push service worker once on mount
//   useEffect(() => {
//     initPushNotifications(navigate);
//   }, [navigate]);

//   // Push-aware toggle — push_enabled triggers browser subscribe/unsubscribe
...
//         if (!ok) return; // permission denied — don't flip
//       } else {
...
//                 {error && <p className="text-[13px] text-[#ef4444] text-center py-[32px]">Failed to load notifications</p>}
...
//                 <p className="text-[11px] text-[#9ca3af] leading-[16px] mb-[14px]">
//                   Control <span className="font-medium text-[#6b7280]">how</span> (email, push, SMS) and{" "}
//                   <span className="font-medium text-[#6b7280]">what</span> (case updates, deadlines, news) you get notified about.
//                 </p>
